...
void DrawStrokeText(int x, int y, RGBA* color, const char* str)
{
	...
	ImGui::GetForegroundDrawList()->AddText(ImVec2(x + 1, y), ImGui::ColorConvertFloat4ToU32(ImVec4(1 / 255.0, 1 / 255.0, 1 / 255.0, 255 / 255.0)), utf_8_2.c_str());
	ImGui::GetForegroundDrawList()->AddText(ImVec2(x, y), ImColor(color->R, color->G, color->B, 255), utf_8_2.c_str());
}
void DrawStrokeText2(int x, int y, RGBA* color, const char* str)
{
	int fontSize = 13.f;
	va_list va_alist;
	//char buf[1024] = { 0 };
	//va_start(va_alist, str);
	//_vsnprintf_s(buf, sizeof(buf), str, va_alist);
	//va_end(va_alist);
	...
	//if (stroke)
	//{
	//ImGui::GetForegroundDrawList()->AddText(ImGui::GetFont(), fontSize, ImVec2(x, y - 1), ImGui::ColorConvertFloat4ToU32(ImVec4(0, 0, 0, 1)), str);
	//ImGui::GetForegroundDrawList()->AddText(ImGui::GetFont(), fontSize, ImVec2(x, y + 1), ImGui::ColorConvertFloat4ToU32(ImVec4(0, 0, 0, 1)), str);
	//ImGui::GetForegroundDrawList()->AddText(ImGui::GetFont(), fontSize, ImVec2(x - 1, y), ImGui::ColorConvertFloat4ToU32(ImVec4(0, 0, 0, 1)), str);
	//ImGui::GetForegroundDrawList()->AddText(ImGui::GetFont(), fontSize, ImVec2(x + 1, y), ImGui::ColorConvertFloat4ToU32(ImVec4(0, 0, 0, 1)), str);
	//}
	ImGui::GetForegroundDrawList()->AddText(ImGui::GetFont(), fontSize, ImVec2(x, y), ImColor(color->R, color->G, color->B, 255), str, 0, 0.0f, 0);
}
void DrawStrokeText3(int x, int y, RGBA* color, const char* str)
{
	int fontSize = 13.f;
	va_list va_alist;
	//char buf[1024] = { 0 };
...
void DrawLine2(const ImVec2& from, const ImVec2& to, uint32_t color, float thickness)
{
	...
	float b = (color) & 0xff;
	ImGui::GetForegroundDrawList()->AddLine(from, to, ImGui::GetColorU32(ImVec4(r / 255, g / 255, b / 255, a / 255)), thickness);
}